...
//Function isSorted
    ...
    public static void main(String args[]) {
        ...
        System.out.println("================================");
        System.out.println("List one sorted:" );
        ...
        System.out.println("================================");
        System.out.println("List two sorted:");
        System.out.println(list2.toString());
        System.out.println("================================");
        System.out.println("MergedList");
        System.out.println(list1.merge(list2).toString());
        System.out.println("================================");
        System.out.println("Concatened list one to  list two ");
        System.out.println(list1.concatenate(list2));
    }
}
